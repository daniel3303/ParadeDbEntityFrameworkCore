...
{
    private static string GetCreateScript<TEntity>()
        where TEntity : class
    {
    ...
    public void NgramParamWithoutNgramTokenizer_Throws()
    {
        var ex = Assert.Throws<InvalidOperationException>(() =>
            GetCreateScript<InvalidNgramParamEntity>()
        );
        Assert.Contains(
    ...
    {
        var ex = Assert.Throws<InvalidOperationException>(() =>
            GetCreateScript<NgramMissingMinMaxEntity>()
        );
    ...
    {
        var ex = Assert.Throws<InvalidOperationException>(() =>
            GetCreateScript<RegexMissingPatternEntity>()
        );
    ...
    {
        var ex = Assert.Throws<InvalidOperationException>(() =>
            GetCreateScript<RegexParamOnNonRegexTokenizerEntity>()
        );
    ...
    {
        var ex = Assert.Throws<InvalidOperationException>(() =>
            GetCreateScript<OrphanNoIndexEntity>()
        );
    ...
    {
        var ex = Assert.Throws<InvalidOperationException>(() =>
            GetCreateScript<FieldAttrNotInIndexEntity>()
        );
...
internal sealed class ConfigTestContext<TEntity> : DbContext
    where TEntity : class
{
