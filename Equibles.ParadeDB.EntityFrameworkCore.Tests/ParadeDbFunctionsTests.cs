...
public class ParadeDbFunctionsTests {
    ...
    public void MatchesFuzzy_full_throws_when_called_directly() {
        Assert.Throws<InvalidOperationException>(() => _ef.MatchesFuzzy("col", "q", 2, true, false));
    }
    ...
    public void MatchesAllFuzzy_full_throws_when_called_directly() {
        Assert.Throws<InvalidOperationException>(() => _ef.MatchesAllFuzzy("col", "q", 1, false, true));
    }
    ...
    public void MatchesTermFuzzy_full_throws_when_called_directly() {
        Assert.Throws<InvalidOperationException>(() => _ef.MatchesTermFuzzy("col", "q", 2, true, true));
    }
    ...
    public void MatchesAllFuzzyBoosted_throws_when_called_directly() {
        Assert.Throws<InvalidOperationException>(() => _ef.MatchesAllFuzzyBoosted("col", "q", 1, 3.0));
    }
