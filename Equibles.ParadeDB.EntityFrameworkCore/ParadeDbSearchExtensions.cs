...
public static class ParadeDbSearchExtensions
{
    ...
    /// </summary>
    public static IQueryable<T> JsonSearch<T>(
        this IQueryable<T> source,
        Expression<Func<T, object>> keyField,
        Action<ParadeDbBooleanQuery> configure
    )
        where T : class
    {
    ...
    /// </summary>
    public static IOrderedQueryable<T> OrderByScoreDescending<T>(
        this IQueryable<T> source,
        Expression<Func<T, object>> keyField
    )
        where T : class
    ...
    /// </summary>
    public static IOrderedQueryable<T> OrderByScore<T>(
        this IQueryable<T> source,
        Expression<Func<T, object>> keyField
    )
        where T : class
    ...
    private static IOrderedQueryable<T> ApplyScoreOrdering<T>(
        IQueryable<T> source,
        Expression<Func<T, object>> keyField,
        string methodName
    )
